...
int main(int argc, const char *argv[])
{
  ...
  int message1[BLEN] = {0x5920,0xc7cc,0x6234,0xb111,0x3090,0x8ab7,0xf373,0x46dd};
	int x[BLEN] = {0x5920,0xc7cc,0x6234,0xb111,0x3090,0x8ab7,0xf373,0x46dd};
	//********************************************************************
	//********************************************************************
	//********************************************************************
